...
prog_char  msg_server[]         PROGMEM  = API_CALL_SERV; 
prog_char  msg_server_host[]    PROGMEM  = API_CALL_HOST; 
prog_char  msg_server_path[]    PROGMEM  = API_CALL_PATH;
prog_uint16_t  msg_server_port  PROGMEM  = API_CALL_PORT;
